...
class OpenAICompatibleAdapter(AIAdapter):
    """Groq, Cerebras, SambaNova, Mistral, Hugging Face (router) vb."""

    def __init__(self, provider_key: str):
        super().__init__(provider_key)
        # max_retries=0: kütüphanenin kendi otomatik (uzun süren) tekrar
        # deneme mekanizmasını kapatıyoruz, kendi kısa retry mantığımızı kullanıyoruz.
        self.client = OpenAI(
